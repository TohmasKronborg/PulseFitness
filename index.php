...
<!-- Dims Nav -->
<nav>
    <a href="index.php"><img src="images/LogoWhite.png" alt="WhiteLogo" class="img-fluid" style="max-width: 100px;"></a>
</nav>
...
<section class="container-fluid mb-5">
    <div class="row mb-5">
        ...
        if (!empty($workouts)) {
            ...
            [$hours, $minutes] = formatTimeFromSeconds($first->total_rest_seconds ?? 0);
            ?>
            ...
            <div class="col-12 d-md-flex justify-content-between align-items-center bg-white rounded-4 p-3">
                ...
                <div>
                    ...
                    <div class="gap-3 mb-3 mb-md-0 d-flex">
                        ...
                        <div class="d-flex flex-center">
                            ...
                            <span><b>Øvelser:
                        <span class="text-primary"><?= (int)$first->total_exercises ?></span>
                    </b></span>
                        </div>
                ...
                <div class="d-flex gap-3 justify-content-between">
                    <a href="#" class="btn rounded-3 bg-light px-5">Info</a>
                    <a href="#" class="btn rounded-3 bg-primary text-white fw-bold px-5">Start</a>
                </div>
    ...
    <div class="row">
        ...
        <?php if (!empty($rest)): ?>
            ...
            <?php foreach ($rest as $workout): ?>
                ...
                <?php
                [$rHours, $rMinutes] = formatTimeFromSeconds($workout->total_rest_seconds ?? 0);
                ?>
...
<footer class="mt-auto rounded-top-circle bg-white position-sticky bottom-0" style="min-height: 85px;">
    <div class="d-flex justify-content-center gap-5" style="margin-top: -25px; margin-bottom: 25px;">
        ...
        <div class="flex-column-center gap-1 align-self-end">
            <a class="p-3 bg-secondary rounded-circle" href="logout.php">
            ...
            <p class="text-center montserrat fw-bold m-0 text-nowrap">Log Ud</p>
        </div>
